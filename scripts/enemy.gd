	...
	match enemy_type:
		...
		"boss_1":
			attack_patterns = [
				...
				{"type": "debuff", "damage": 3, "debuff_type": "weak", "duration": 3, "value": 1, "weight": 2, "icon": "debuff"},
				{"type": "debuff", "damage": 0, "debuff_type": "vulnerable", "duration": 3, "value": 2, "weight": 3, "icon": "debuff"}
			]
		_:
			attack_patterns = [
